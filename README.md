...
git subrepo clone https://github.com/abcue/tue.git cue.mod/pkg/github.com/abcue/tue
git subrepo clone https://github.com/abcue/cup.git cue.mod/pkg/github.com/abcue/cup
```
